...
local newBlock = hasFFi and function() return ffi.new("uint32_t[80]") end or
                     function()
        local t = {}
...
local function create(sync)
    ...
    function digest()
        ...
        write(
            totalLength > 0xffffffffff and floor(totalLength / 0x10000000000) or
                0x00)
        write(totalLength > 0xffffffff and floor(totalLength / 0x100000000) or
                  0x00)
    ...
    function processBlock()
        ...
        for t = 0, 79 do
            ...
            e, d, c, b, a = d, c, rol(b, 30), a, tobit(
                                unsigned(rol(a, 5)) + unsigned(f) + unsigned(e) +
                                    unsigned(k) + W[t])
