...
local DEFAULT_CIPHERS =
    'TLS_AES_128_GCM_SHA256:TLS_AES_128_CCM_SHA256:' .. -- TLS 1.3
...
return function(options)
    local ctx = openssl.ssl.ctx_new(options.protocol or DEFAULT_SECUREPROTOCOL,
    ...
    if ca then
        ...
        for i = 1, #ca do assert(store:add(ca[i])) end
